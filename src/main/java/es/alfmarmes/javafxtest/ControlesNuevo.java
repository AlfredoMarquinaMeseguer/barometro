...
import es.alfmarmes.javafxtest.Vista;
import javafx.fxml.FXML;
...
/**
 * La clase Controles representa el controlador de la interfaz de usuario
 * JavaFX. Maneja la lógica de los elementos de la interfaz de usuario y se
 * comunica con la clase Vista para realizar acciones.
 *
 * @author Sergio
 */
public class ControlesNuevo implements Initializable {
    ...
    /**
     * El ToggleGroup utilizado para asegurar que sólo se selecciona una unidad
     * de presión a la vez.
     */
    @FXML
    ...
    /**
     * El ImageView utilizado para mostrar un icono basado en la actualización
     * de la medición.
     */
    @FXML
    ...
    private void actualizar(ActionEvent event) {
        ...
        fecha = vista.crearLocalDateTime(datePickerFecha,
                tfHora);

        Medicion a = vista.annadirMedicion(fecha, presion, siMmhg);
        historial.appendText(a.toString() + "\n");
        imageViewIcono.setImage(vista.getImage());
    }

    public void recibirVista(Vista vista) {
        this.vista = vista;
    }
}
